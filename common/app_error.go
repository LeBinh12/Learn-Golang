...
func ErrDB(err error) *AppError {
	return NewFullErrorResponse(http.StatusInternalServerError, err, "something went ưởng with DB", err.Error(), "DB_ERROR")
}
...
func ErrEntityDeleted(entity string, err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("%s has been deleted", strings.Title(entity)),
